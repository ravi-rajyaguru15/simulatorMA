...
FPGA_ACTIVE_INT_POWER = Gaussian(.05, .01)
FPGA_ACTIVE_AUX_POWER = Gaussian(.085, .01)
...
FPGA_RECONFIGURATION_INT_POWER = Gaussian(.05, .01)
FPGA_RECONFIGURATION_AUX_POWER = Gaussian(.1, .01)
