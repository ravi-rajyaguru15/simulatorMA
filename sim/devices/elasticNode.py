...
class elasticNode(node):
	...
	def __init__(self, clock, platform, queue, index, episodeFinished, currentSystemState, alwaysHardwareAccelerate):
		node.__init__(self, clock, platform, index, currentSystemState=currentSystemState, components = None, episodeFinished=episodeFinished, alwaysHardwareAccelerate=alwaysHardwareAccelerate)
