...
def runThread(agent, numEpisodes, numDevices, taskOptions, results, finished):
    ...
    exp = SimpleSimulation(numDevices=numDevices, maxJobs=10, agentClass=agent, tasks=taskOptions, systemStateClass=targetedSystemState, reconsiderBatches=False, scenarioTemplate=RANDOM_SCENARIO_ROUND_ROBIN)
    exp.scenario.setInterval(0.25)
